document.addEventListener('DOMContentLoaded', () => {
  ...
  const cardArray = [
    ...
    {
      name: '2',
      img: 'La mamma non è riuscita a far funzionare il fornello da campo.'
    },
    {
      name: '3',
    ...
    {
      name: '3',
      img: 'Dovremo accontentarci di una colazione fredda.'
    },
    {
      name: '4',
    ...
    {
      name: '4',
      img: "Papà è venuto a vedere cosa c'era che non andava."
    },
    /* {
      name: '5',
    ...
    {
      name: '8',
      img: "C'era abbondanza per tutti."
    },
    {
      name: '9',
      img: 'I love camping.'
...
audio1.play();
    ...
    if  (cardsWon.length === cardArray.length/2) {
      resultDisplay.innerHTML = " <h1>Congratulations! You found them all!</h1><h2>Level completed!</h2><a href='https://elaidina.github.io/ita1'> Continue to next level </a>";
